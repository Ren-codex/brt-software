...
class UserClass
{
    ...
    public function role($request){
        ...
        $data = UserRole::with('role:id,name','added:id','added.profile:user_id,firstname,middlename,lastname,suffix','removed:id','removed.profile:user_id,firstname,middlename,lastname,suffix')->where('id',$id)->first();
        return [
