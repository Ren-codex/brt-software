...
class LibrariesDefaultPermissionsSeeder extends Seeder
{
    /**
     ...
     * gate on every Libraries route today, so it's the only one that
    ...
    {
        $module = Module::where('key', 'libraries')->first();
        if (!$module) {
