...
class ModulesAndSubmodulesSeederTest extends TestCase
{
    ...
    public function test_seeds_expected_modules_and_pilot_submodules(): void
    {
        ...
        $this->assertEquals(
            ['sales_orders', 'ar_invoices', 'receipts', 'sales_returns', 'remittances', 'check_monitoring'],
    ...
    public function test_seeder_is_idempotent(): void
    {
        ...
        $this->assertEquals(6, Module::where('key', 'sales')->firstOrFail()->submodules()->count());
    }
    ...
    public function test_seeds_accounting_submodules(): void
    {
        ...
        $this->assertEquals(
            [
                ...
                'petty_cash', 'expenses', 'bank_reconciliation', 'accounts_payable', 'check_register',
            ],
