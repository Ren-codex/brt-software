...
Route::middleware(['2fa', 'auth', 'is_active'])->group(function () {
    ...
    Route::resource('/sales-orders', App\Http\Controllers\Modules\SalesOrderController::class)->except(['create', 'edit']);
    ...
    Route::resource('/sales-orders-external', App\Http\Controllers\Modules\SalesOrderExternalController::class)->except(['create', 'edit']);
    ...
    Route::resource('/ar-invoices', App\Http\Controllers\Modules\ArInvoiceController::class)->except(['create', 'edit']);
    Route::resource('/employees', App\Http\Controllers\Modules\EmployeeController::class)->except(['create', 'edit'])
    ...
    Route::resource('/customers', App\Http\Controllers\Modules\CustomerController::class)->except(['create', 'edit'])
    ...
    Route::get('/customers/{id}/purchase-history', [App\Http\Controllers\Modules\CustomerController::class, 'purchaseHistory'])
        ->middleware('permission:customers,view');
    Route::resource('/suppliers', App\Http\Controllers\Libraries\SupplierController::class)->except(['create', 'edit']);
    ...
    // Gated by the granular permission: middleware on each route below.
    Route::resource('/users', App\Http\Controllers\System\UserController::class)->except(['create', 'edit'])
        ->middlewareFor('destroy', 'permission:user_management,admin')
    ...
    Route::resource('/libraries/brands', App\Http\Controllers\Libraries\BrandController::class)->except(['create', 'edit'])
    ...
    Route::resource('/libraries/units', App\Http\Controllers\Libraries\UnitController::class)->except(['create', 'edit'])
    ...
    Route::resource('/libraries/products', App\Http\Controllers\Libraries\ProductController::class)->except(['create', 'edit'])
    ...
    Route::resource('/libraries/statuses', App\Http\Controllers\Libraries\StatusController::class)->except(['create', 'edit'])
    ...
    Route::resource('/libraries/positions', App\Http\Controllers\Libraries\PositionController::class)->except(['create', 'edit'])
        ->middlewareFor(['index', 'show'], 'permission:employees,view')
        ->middlewareFor(['store', 'update'], 'permission:employees,encoder')
        ->middlewareFor('destroy', 'permission:employees,admin');
    Route::resource('/libraries/salaries', App\Http\Controllers\Libraries\SalaryController::class)->except(['create', 'edit'])
        ->middlewareFor(['index', 'show'], 'permission:employees,view')
        ->middlewareFor(['store', 'update'], 'permission:employees,encoder')
        ->middlewareFor('destroy', 'permission:employees,admin');
    Route::resource('/libraries/locations', App\Http\Controllers\Libraries\LocationController::class)->except(['create', 'edit'])
    ...
    Route::resource('/libraries/payroll-items', App\Http\Controllers\Libraries\PayrollItemController::class)->except(['create', 'edit'])
        ->middlewareFor(['show'], 'permission:payroll,payroll_settings,view')
    ...
    Route::resource('/libraries/packagings', App\Http\Controllers\Libraries\PackagingController::class)->except(['create', 'edit'])
    ...
    Route::resource('/stock-returns', App\Http\Controllers\StockReturnController::class)->except(['create', 'edit'])
        ->middlewareFor(['index', 'show'], 'permission:inventory,stock_returns,view')
        ->middlewareFor(['store', 'update'], 'permission:inventory,stock_returns,encoder')
        ->middlewareFor('destroy', 'permission:inventory,stock_returns,admin')
        ->middlewareFor(['index', 'show'], 'permission:inventory,stock_returns,view')
    ...
    Route::resource('inventory-stocks', App\Http\Controllers\InventoryStockController::class)->except(['create', 'edit'])
        ->middlewareFor(['index', 'show'], 'permission:inventory,inventory_stocks,view')
        ->middlewareFor(['store', 'update'], 'permission:inventory,inventory_stocks,encoder')
        ->middlewareFor('destroy', 'permission:inventory,inventory_stocks,admin')
        ->middlewareFor(['index', 'show'], 'permission:inventory,inventory_stocks,view')
    ...
    Route::resource('/payroll-settings', App\Http\Controllers\Modules\PayrollSettingController::class)->except(['create', 'edit'])
        ->middlewareFor(['index', 'show'], 'permission:payroll,payroll_settings,view')
        ->middlewareFor(['store', 'update'], 'permission:payroll,payroll_settings,encoder')
        ->middlewareFor('destroy', 'permission:payroll,payroll_settings,admin')
        ->middlewareFor('index', 'permission:payroll,payroll_settings,view')
    ...
    Route::resource('/payroll-templates', App\Http\Controllers\Modules\PayrollTemplateController::class)->except(['create', 'edit'])
        ->middlewareFor(['show'], 'permission:payroll,payroll_templates,view')
    ...
    Route::resource('/loans', App\Http\Controllers\Modules\LoanController::class)->except(['create', 'edit'])
        ->middlewareFor(['show'], 'permission:payroll,loans,view')
    ...
    Route::resource('/loan-payments', App\Http\Controllers\Modules\LoanPaymentController::class)->except(['create', 'edit'])
        ->middlewareFor(['show'], 'permission:payroll,loans,view')
        ->middlewareFor('index', 'permission:payroll,loans,view')
        ->middlewareFor(['store', 'update'], 'permission:payroll,loans,encoder')
        ->middlewareFor('destroy', 'permission:payroll,loans,admin');
    ...
    // Only a blanket 'view' gate here — approve/reject vs. release require
    ...
    // Contact Management (Guest Messages) has no entry in the permission
    // catalogue, so it stays behind the Administrator role gate.
    Route::middleware(['role:Administrator'])->group(function () {
        Route::resource('/contacts', App\Http\Controllers\Modules\ContactController::class)->except(['create', 'edit']);
