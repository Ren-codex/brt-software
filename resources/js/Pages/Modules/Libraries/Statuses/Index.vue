            ...
            <div class="library-card">
                <div class="library-card-header">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h4 class="header-title mb-1">Status Management</h4>
                                <p class="header-subtitle mb-0">Manage system statuses and badges</p>
                            </div>
                        </div>
                ...
                <div class="library-card-body">
                    ...
                    <div class="table-section">
                        ...
                        <table class="table align-middle table-centered mb-0">
                            ...
                            <tbody>
                                <TableLoadingRow v-if="loading" :colspan="7" message="Loading statuses..." />
                                <template v-else>
