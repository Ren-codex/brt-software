                ...
                <div class="card-header bg-light-subtle">
                    <div class="d-flex mb-n3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="text-muted text-truncate-two-lines fs-12">A comprehensive list of units</p>
                        </div>
                    ...
                    <b-row class="mb-2 ms-1 me-1" style="margin-top: 12px;">
                        <b-col lg>
                            <div class="input-group mb-1">
                                ...
                                <input type="text" v-model="filter.keyword" placeholder="Search Unit" class="form-control" style="width: 20%;">
...
export default {
    ...
    methods: {
        ...
        fetch(page_url){
            page_url = page_url || '/libraries/units';
            axios.get(page_url,{
                params : {
        ...
        async onDelete(list, index) {
            ...
            if (result.isConfirmed) {
                axios.delete(`/libraries/units/${list.id}`)
                    .then(response => {
                        this.fetch();
                        Swal.fire(
                            'Deleted!',
