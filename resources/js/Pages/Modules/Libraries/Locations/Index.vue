...
<Head title="Locations"/>
    <PageHeader title="Location Management" pageTitle="List" />
    <BRow>
        <div class="col-md-12">
                ...
                <div class="library-card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h4 class="header-title mb-1">Location Management</h4>
                                <p class="header-subtitle mb-0">Manage and organize your location catalog</p>
                            </div>
                        </div>
                        ...
                        <table class="table align-middle table-centered mb-0">
                            ...
                            <tbody>
                                <tr v-for="(list,index) in lists" v-bind:key="index" @click="selectRow(index)" :class="{
                                    ...
                                    <td>{{ list.name }}</td>
                                    <td>
                                        <span class="badge" :class="list.is_active ? 'bg-success' : 'bg-danger'">
    ...
    methods: {
        ...
        async onDelete(list, index) {
            ...
            if (result.isConfirmed) {
                axios.delete(`/libraries/locations/${list.id}`)
                    .then(response => {
                        this.fetch();
                        Swal.fire(
                            'Deleted!',
