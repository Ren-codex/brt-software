                        ...
                        <div class="form-group form-group-half">
                             <div class="alert alert-danger alert-dismissible alert-additional fade show mb-xl-0 material-shadow" role="alert">
                                ...
                                <div class="bg-primary p-2 rounded alert-content">
                                    <p class="mb-0 fs-10">Setting this role will allow the user’s access and permissions associated with the <strong class="text-decoration-underline">{{ selected.role?.name }}</strong> module.</p>
                                </div>
                            </div>
                        </div>
