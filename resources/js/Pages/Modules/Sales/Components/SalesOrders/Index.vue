                                    ...
                                    <tr @click="toggleRowExpansion(index)" :class="{
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-1">
                                                ...
                                                <b-button v-if="list.status?.slug !== 'cancelled' && list.status?.slug !== 'closed' && list.status?.slug !== 'sales-returned' && list.status?.slug !== 'sales-return-approval'" @click.stop="onCancel(list.id)" variant="outline-danger" v-b-tooltip.hover title="Cancel" size="sm" class="btn-icon rounded-circle">
