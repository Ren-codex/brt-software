<template>
<Head title="Users"/>
    <PageHeader title="Sales Order Management" pageTitle="List" />
    <BRow>
        <div class="col-md-12">
                ...
                <div class="card-header bg-light-subtle">
                    <div class="d-flex mb-n3">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="mb-0 fs-14"><span class="text-body">List of Sales Order</span></h5>
                            <p class="text-muted text-truncate-two-lines fs-12">A comprehensive list of Sales Order</p>
                        </div>
