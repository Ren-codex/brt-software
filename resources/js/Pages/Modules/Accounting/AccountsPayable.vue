<template>
    <div>
        <PageHeader title="Accounting Module" pageTitle="Accounts Payable" />

        <div class="inventory-container">
            <AccountingSidebar active-tab="accounts_payable" :stats="stats" />

            <div class="inventory-main">
                <div class="report-shell">
                    <div class="report-header">
                        <div>
                            <p class="report-kicker mb-1">Disbursements</p>
                            <h3 class="report-title mb-1">Accounts Payable</h3>
                            <p class="report-subtitle mb-0">
                                Review payable-related journal movements generated from stock receipts and supplier obligations.
                            </p>
                        </div>
                    </div>
                    ...
                    <div v-if="!dataReady" class="empty-panel">
                        ...
                        <span>Accounting tables are not ready yet. Run the accounting migrations to populate payable data.</span>
                    </div>

                    <div v-else class="report-panel">
                        <div class="panel-head">
                            <h5 class="panel-title">Payable Movements</h5>
                            <p class="panel-subtitle mb-0">Latest journal lines affecting Accounts Payable.</p>
                        </div>
