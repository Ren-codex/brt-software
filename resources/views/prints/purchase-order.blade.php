...
<body>
    ...
    <div class="summary-container">
        ...
        <div class="total-block">
            ...
            <div style="font-size: 22px; font-weight: bold;">PHP {{ number_format($purchase_order->total_amount, 2) }}</div>
        </div>
    </div>
    ...
    <table class="meta-table">
        ...
        <tbody>
            <tr>
                ...
                <td>7 Days</td>
                <td>---</td>
                <td>{{ \Carbon\Carbon::parse($purchase_order->expected_delivery)->format('m/d/Y') }}</td>
                <td>---</td>
            </tr>
        </tbody>
    </table>
            ...
            <td style="width: 300px;">
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td class="text-right">PHP {{ number_format($purchase_order->total_amount, 2) }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr class="grand-total-box">
                        ...
                        <td class="text-right" style="padding: 10px 5px;">PHP {{ number_format($purchase_order->total_amount, 2) }}</td>
                    </tr>
                </table>
            </td>
        </tr>
